...
Arc / Xe hardware. This file pins the *scaffolding* that's already
in tree: the registry slot is reserved, the stub surface raises a
clear error, and the family enum has the expected value. Real
SPIR-V output tests will replace these once the lowerer is
implemented.
"""
...
def test_lower_module_raises_with_pointed_error():
    """The stub surface raises NotImplementedError with a clear
    message — not a silent fallback or a KeyError."""
