...
def test_silu_accepts_e4m3():
    ...
    out_e4m3 = pcf.silu(e4m3)
    out_bf16 = pcf.silu(bf16)
...
def test_rmsnorm_accepts_e4m3():
    ...
    out_e4m3 = pcf.rmsnorm(e4m3)
    out_bf16 = pcf.rmsnorm(bf16)
    assert out_e4m3.dtype == "e4m3"
    _compare(out_e4m3, out_bf16)
...
def test_ada_rmsnorm_accepts_e4m3():
    ...
    out_e4m3 = pcf.ada_rmsnorm(e4m3, scale_bf16, bias_bf16)
    out_bf16 = pcf.ada_rmsnorm(bf16, scale_bf16, bias_bf16)
    assert out_e4m3.dtype == "e4m3"
    _compare(out_e4m3, out_bf16)
...
def test_head_rmsnorm_accepts_e4m3():
    ...
    out_e4m3 = pcf.head_rmsnorm(e4m3, n_q_heads=n_q, n_kv_heads=n_kv, Dh=Dh)
    out_bf16 = pcf.head_rmsnorm(bf16, n_q_heads=n_q, n_kv_heads=n_kv, Dh=Dh)
    assert out_e4m3.dtype == "e4m3"
    _compare(out_e4m3, out_bf16)
...
def test_value_residual_packed_accepts_e4m3():
    ...
    out_bf16 = pcf.value_residual_packed(
