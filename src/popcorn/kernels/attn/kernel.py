...
from popcorn.kernels.attn.baselines import attn_baselines
...
from popcorn.kernels.gemm.mma_shapes import lookup_mma
...
class AttnKernel(Kernel):
    ...
    def mma_sites(cls, spec) -> list:
        from popcorn.kernels.base import MmaSite
