...
import as ``from popcorn.blocks.dsl import ...`` (or more commonly
via ``popcorn.blocks``'s flat re-export):
...
from popcorn.blocks.dsl.block_context import Block, BlockContext, SetupBlock
from popcorn.blocks.dsl.carry import Carry, Stage
from popcorn.blocks.dsl.context import _ACTIVE_BCTX, _ACTIVE_KCTX, active_bctx, active_kctx
...
from popcorn.blocks.dsl.tensors import C, TensorDecl, _to_value
