...
if TYPE_CHECKING:
    from popcorn.lower.msl.lower import LoweredMslKernel
...
class MlxDriver:
    ...
    def probe(self, index: int) -> DeviceCaps:
        ...
        from popcorn.device import chip_gen_from_metal_info
    ...
    def launch_mlx(
        ...
        # MLX's grid is in threads, not threadgroups. Popcorn's kernels
