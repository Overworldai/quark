...
Collects every MMA descriptor Popcorn can lower, along with the
...
from popcorn.device import ChipGeneration
from popcorn.ir.module import MmaShape
from popcorn.ir.types import DType
...
# that Popcorn's PTX lowerer doesn't support. Metal-only by design;
...
# whole time but popcorn never registered it.
# ---------------------------------------------------------------------------
...
# Every descriptor known to Popcorn. Adding a new MMA means adding one
