...
def _is_zero_vec_build(value) -> bool:
    ...
    """
    from popcorn.ir.op import ConstOp, VecBuildOp
...
def _is_nonzero_vec_build(value) -> bool:
    ...
    """
    from popcorn.ir.op import VecBuildOp
...
def visit_frag_reduce(self, op: FragReduceOp, ctx: _MslCtx) -> None:
    ...
    """
    from popcorn.ir.frag_tile import APPLE_ACC_ROW_REDUCE_BUTTERFLY
...
def visit_load_matrix(self, op: LoadMatrixOp, ctx: _MslCtx) -> None:
    ...
    from popcorn.ir import SharedRegion as _SharedRegion
