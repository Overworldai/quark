...
``_ACTIVE_BUILDER`` in ``quark.ir.value`` — one pattern, three handles.
"""
...
if TYPE_CHECKING:
    from quark.blocks.dsl.block_context import BlockContext
...
_ACTIVE_KCTX: ContextVar[KernelContext | None] = ContextVar("quark_active_kctx")
_ACTIVE_BCTX: ContextVar[BlockContext | None] = ContextVar("quark_active_bctx")
