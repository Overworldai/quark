...
from quark.blocks.dsl import BlockContext, SetupBlock, SmemTile
from quark.ir import DType, SharedRegion

if TYPE_CHECKING:
    from quark.ir.mma_registry import MmaConfig
...
class SmemPlan(SetupBlock):
    ...
    def paired(
        ...
        * **per-lane B view** — shuffled B uses ``lane_id * frag_elems``
        ...
        """
        from quark.blocks.dsl import _ACTIVE_BCTX
