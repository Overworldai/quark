...
Per quark launcher proposal §5.1 (which is a stub in the proposal —
...
class CudaDriver:
    ...
    def probe(self, index: int) -> DeviceCaps:
        ...
        Mirrors `quark.device._probe_cuda_via_torch` but reads from
        ...
        # Pull the per-arch matmul / dtype tables from quark.device.
        from quark.device import _default_dtypes_for, _default_matmul_shapes_for  # type: ignore
