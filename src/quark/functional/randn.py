"""``quark.functional.randn`` — on-device standard-normal generator.

    out = qf.randn(shape=(1, 65536), dtype="bf16", counter_offset=cnt,
                    out=preallocated_tensor, seed0=..., seed1=...)

Counter-based stateless Philox4x32-10 + Box-Muller — see
``quark.kernels.randn.kernel`` for the kernel body. One launch produces
