...
raw bytes directly to device via ``QuarkTensor.from_bytes``.
...
def load_safetensors(
    ...
    *,
    ...
    # so QuarkTensor.from_bytes can memcpy_htod directly from the mmap.
    mv = memoryview(mm)
    ...
    try:
        for name, info in header.items():
            ...
            t = QuarkTensor.from_bytes(raw, shape, pc_dtype)
