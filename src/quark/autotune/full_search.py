...
def run_full_search(
    ...
    *,
    ...
    make_tensors/reference are unavailable. ``tune_space`` overrides
    the kernel's default space — used by autotune callers that want
    to pin problem-specific config overrides.
    """
