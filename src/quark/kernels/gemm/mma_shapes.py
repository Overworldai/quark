...
The real registry moved to :mod:`quark.ir.mma_registry` in M1 of the
...
Do not add new descriptors here — edit ``quark.ir.mma_registry``.
"""

from __future__ import annotations

from quark.ir.mma_registry import (
    _BF16_K16,
    _E4M3_K16,
    _E4M3_K32,
    _E5M2_K16,
...
__all__ = (  # noqa: RUF022 — intentionally orders public before private _-prefixed
    ...
    # test suite migrates to ``quark.ir.mma_registry.ALL_SHAPES``.
    "_BF16_K16",
    "_F16_K16",
    "_E4M3_K16",
    "_E5M2_K16",
