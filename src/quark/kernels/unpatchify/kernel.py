...
from quark.kernels.unpatchify.baselines import unpatchify_baselines
from quark.kernels.unpatchify.config import UnpatchifyConfig
from quark.kernels.unpatchify.problems import unpatchify_problems
from quark.kernels.unpatchify.reference import unpatchify_reference_numpy
...
class UnpatchifyKernel(Kernel):
    ...
    def build(self) -> None:
        ...
        from quark.lang import convert, frag_for_each, load
